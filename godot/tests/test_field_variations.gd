...
func _test_ring_out(check: Callable) -> void:
	...
	r.enemies = [BattleRequest.Launch.new(_stats(1.5, 0.5, 15.0), Vector2(5, 5), Vector2.ZERO)]
	...
	r2.enemies = [BattleRequest.Launch.new(_stats(1.5, 0.5, 15.0), Vector2(5, 5), Vector2.ZERO)]
