...
func _init() -> void:
	...
	print("== obstaclemarks ==")
	_test_obstacle_marks()

	print("== bossmark ==")
	_test_boss_mark()

	print("== stageslope ==")
	_test_stage_slope_mark()
...
func _test_obstacle_marks() -> void:
	var suite = load("res://tests/test_obstacle_marks.gd").new()
	suite.run(_check)
	_done("obstaclemarks")


func _test_boss_mark() -> void:
	var suite = load("res://tests/test_boss_mark.gd").new()
	suite.run(_check)
	_done("bossmark")


func _test_stage_slope_mark() -> void:
	var suite = load("res://tests/test_stage_slope_mark.gd").new()
	suite.run(_check)
	_done("stageslope")


func _test_slope_contour() -> void:
...
func _test_reward_quality() -> void:
	var suite = load("res://tests/test_reward_quality.gd").new()
	suite.run(_check)
	_done("rewardquality")
...
func _test_wall_impact_damping() -> void:
...
func _test_enemy_mutual_drain() -> void:
...
func _test_wall_damage_readout() -> void:
	var suite = load("res://tests/test_wall_damage_readout.gd").new()
	suite.run(_check)
	_done("walldamage")
...
func _test_remaining_text() -> void:
	var suite = load("res://tests/test_remaining_rps_text.gd").new()
	suite.run(_check)
	_done("remaintext")


func _test_growth_text() -> void:
	var suite = load("res://tests/test_victory_growth_text.gd").new()
	suite.run(_check)
	_done("growthtext")


func _test_battle_defaults() -> void:
...
func _test_field_flavor() -> void:
	var suite = load("res://tests/test_field_flavor.gd").new()
	suite.run(_check)
	_done("fieldflavor")


func _test_next_field_list() -> void:
	var suite = load("res://tests/test_next_field_list.gd").new()
	suite.run(_check)
	_done("nextfieldlist")
...
func _test_wall_cost_preview() -> void:
	var suite = load("res://tests/test_wall_cost_preview.gd").new()
	suite.run(_check)
	_done("wallcost")


func _test_rendezvous_preview() -> void:
	var suite = load("res://tests/test_rendezvous_preview.gd").new()
	suite.run(_check)
	_done("rendezvous")


func _test_part_preview() -> void:
