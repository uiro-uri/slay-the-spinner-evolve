...
static func all() -> Array[EnemyData]:
	return [
		...
		_enemy(4, "ENEMY_4_1", 3.0, 1.6, 0.98, 1.0, 26.0, 0.75),
		_enemy(4, "ENEMY_4_2", 2.8, 1.7, 0.985, 1.0, 26.7, 0.75),
		_enemy(4, "ENEMY_4_3", 3.6, 1.5, 0.98, 1.0, 25.6, 0.75),
		_enemy(4, "ENEMY_4_4", 2.4, 1.78, 0.985, 1.0, 27.3, 0.75),
		_enemy(4, "ENEMY_4_5", 3.1, 1.62, 0.982, 1.0, 25.5, 0.75),
