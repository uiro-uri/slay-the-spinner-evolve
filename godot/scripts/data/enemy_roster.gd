...
static func all() -> Array[EnemyData]:
	return [
		...
		# 追加種も硬さを揃え形だけ違う。
		_enemy(5, "ENEMY_5_1", 4.5, 2.4, 0.98, 1.0, 33.8, 0.65),
		_enemy(5, "ENEMY_5_2", 5.2, 2.25, 0.98, 1.0, 33.3, 0.65),
		_enemy(5, "ENEMY_5_3", 3.9, 2.55, 0.98, 1.0, 34.6, 0.65),
		_enemy(5, "ENEMY_5_4", 4.6, 2.4, 0.98, 1.0, 33.0, 0.65),
		_enemy(5, "ENEMY_5_5", 4.9, 2.32, 0.98, 1.0, 33.3, 0.65),
	]
