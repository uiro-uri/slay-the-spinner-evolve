...
static func all() -> Array[EnemyData]:
	return [
		...
		_enemy(3, "ENEMY_3_3", 2.5, 1.12, 0.98, 1.0, 19.8, 0.85),
		_enemy(3, "ENEMY_3_4", 1.55, 1.32, 0.985, 1.0, 22.9, 0.85),
		...
		_enemy(4, "ENEMY_4_3", 3.05, 1.5, 0.98, 1.0, 25.6, 0.75),
		_enemy(4, "ENEMY_4_4", 2.05, 1.78, 0.985, 1.0, 27.3, 0.75),
