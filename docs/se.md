...
クリアファンファーレは `jingles_HIT` を同音で三連打 → 一拍置いて → 長3度→5度の上昇アルペジオ →
締めにオクターブを16分で連打して主音（オクターブ）に着地させる短い旋律。5度で止めると
ドミナントで開放的なままなので、オクターブまで上げて連打で解決させている。`AudioManager.play_clear_fanfare()` が
